...
import com.aspirephile.pedifeed.android.feeder.FeederFragment;
import com.aspirephile.pedifeed.android.record.Record;
import com.aspirephile.pedifeed.android.record.RecordListFragment;
import com.aspirephile.pedifeed.android.schedule.Schedule;
import com.aspirephile.pedifeed.android.schedule.ScheduleListFragment;
...
public class HomeActivity extends AppCompatActivity implements FeederFragment.OnFragmentInteractionListener, RecordListFragment.OnListFragmentInteractionListener, ScheduleListFragment.OnListFragmentInteractionListener {
    ...
    public void onListFragmentInteraction(Schedule.RowItem item) {
        Db.getScheduleManager().deleteSchedule(item._id);
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return RecordListFragment.newInstance(1);
                case 1:
                    return FeederFragment.newInstance();
                case 2:
