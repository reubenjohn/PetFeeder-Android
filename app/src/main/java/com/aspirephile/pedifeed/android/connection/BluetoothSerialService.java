...
package com.aspirephile.pedifeed.android.connection;
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //mEmulatorView.append(String.valueOf(bytes[0]));
                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(MESSAGE_READ, bytes[0], id++, buffer).sendToTarget();
                } catch (IOException e) {
