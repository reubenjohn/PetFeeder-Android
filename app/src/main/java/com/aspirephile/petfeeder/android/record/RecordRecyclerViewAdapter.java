...
public class RecordRecyclerViewAdapter extends RecyclerView.Adapter<RecordRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (item.status.equals("COMPLETED")) {
            holder.statusView.setBackgroundColor(Color.GREEN);
        } else if (item.status.equals("PENDING")) {
            holder.statusView.setBackgroundColor(Color.GRAY);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView timestampView, quantityView, statusView;
        public Item mItem;
